...
static void do_test(test_result & result)
  ...
  "stralgo_trim_left"_test = [&]
  {
    auto fn_tmpl = []<typename char_type>(char_type const *) -> metatests::test_result
    {
      ...
      constexpr_test(
        equal(stralgo::trim_left(t1a), cfs("Lorem ipsum dolor sit amet, consectetur adipiscing elit. \t\r\n"))
      );
      ...
      constexpr_test(
        stralgo::trim_left(t1a, char_type(' '))
        == cfs("\t\r\nLorem ipsum dolor sit amet, consectetur adipiscing elit. \t\r\n")
      );
      constexpr_test(
        stralgo::trim_left(t1a, cfs("Lorem  \t\r\n"))
...
static void do_test(test_result & result)
  ...
  "stralgo_trim_right"_test = [&]
  {
    auto fn_tmpl = []<typename char_type>(char_type const *) -> metatests::test_result
    {
      ...
      constexpr_test(
        stralgo::trim_right(t1a) == cfs(" \t\r\nLorem ipsum dolor sit amet, consectetur adipiscing elit.")
      );
      constexpr_test(stralgo::trim_right(t1a, std::basic_string_view<char_type>{}) == t1a);
      constexpr_test(
        stralgo::trim_right(t1a, char_type('\n'))
        == cfs(" \t\r\nLorem ipsum dolor sit amet, consectetur adipiscing elit. \t\r")
      );
      constexpr_test(
        stralgo::trim_right(t1a, cfs("Lorem  \t\r\nelit."))
...
static void do_test(test_result & result)
  ...
  "stralgo_trim"_test = [&]
  {
    auto fn_tmpl = []<typename char_type>(char_type const *) -> metatests::test_result
    {
      ...
      constexpr_test(
        stralgo::trim(t1a, char_type('\n'))
        == cfs(" \t\r\nLorem ipsum dolor sit amet, consectetur adipiscing elit. \t\r")
      );
      constexpr_test(
        stralgo::trim(t1a, cfs("Lorem  \t\r\nelit.")) == cfs("psum dolor sit amet, consectetur adipiscing")
      );
      return {};
    };
    result |= run_consteval_test<char_type_list>(fn_tmpl);
...
static void do_test(test_result & result)
  ...
  "stralgo_trim"_test = [&]
  {
    ...
    {
      constexpr cfs_t<char_type> cfs;
      auto constexpr t1{cfs("Lorem ipsum")};
      auto constexpr t1b{cfs("Lorem ipsum")};
  ...
  "stralgo_merge"_test = [&]
  {
    auto fn_tmpl = []<typename char_type>(char_type const *) -> metatests::test_result
    {
      ...
      constexpr auto expected{
        cfs("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum rutrum leo libero")
      };
...
static void do_test(test_result & result)
  ...
  "stralgo_merge_range"_test = [&]
  {
    auto fn_tmpl = []<typename char_type>(char_type const *) -> metatests::test_result
    {
      constexpr cfs_t<char_type> cfs;
      std::array tst1 = {
        small_vectors::basic_string<char_type>{cfs("Lorem ipsum")},
        small_vectors::basic_string<char_type>{cfs("Lorem ipsum dolor ")},
        small_vectors::basic_string<char_type>{cfs("sit amet")},
        small_vectors::basic_string<char_type>{},
        small_vectors::basic_string<char_type>{cfs(",consectetur adipiscing elit.")}
      };
