...
struct cfs_t
  ...
  inline constexpr auto operator()(char_type const (&str)[N]) const noexcept
    {
    return small_vectors::basic_fixed_string<decl_chr_type, N - 1>(str);
    }
  };
...
static void do_test(test_result & result)
  ...
  "calculate_size_div_info"_test = [&]
  {
    auto fn_tmpl = []() -> metatests::test_result
    {
      ...
      constexpr_test(
        stralgo::detail::calculate_size_div_info<10>(18446744073709551610ull).divisor_ == 10000000000000000000ull
      );
  ...
  "stralgo_integral_to_ascii_base10"_test = [&]
  {
    auto fn_tmpl = []<typename char_type>(char_type const *) -> metatests::test_result
    {
      ...
      std::array<char_type, integral_to_string_max_size> buffer_{};
        ...
        auto itbeg{buffer_.begin()};
        auto oit = stralgo::integral_to_ascii<traits{.precision = 6, .padd_with = padd_with_e::zeros}>(value, itbeg);
        std::basic_string_view res{itbeg, oit};
        constexpr_test(expected == res);
        }
        {
        ...
        auto itbeg{buffer_.begin()};
        auto oit = stralgo::integral_to_ascii<traits{.precision = 22, .padd_with = padd_with_e::zeros}>(value, itbeg);
        std::basic_string_view res{itbeg, oit};
        constexpr_test(expected == res);
        }
      return {};
  ...
  "stralgo_integral_to_ascii_base16"_test = [&]
  {
    auto fn_tmpl = []<typename char_type>(char_type const *) -> metatests::test_result
    {
      ...
      constexpr auto hex_upper = traits{.format = format_e::hexadecimal, .char_case = char_case_e::uppercase};
        ...
        constexpr auto expected{cfs("")};
        auto itbeg{buffer_.begin()};
        auto oit = stralgo::integral_to_ascii<traits{.precision = 0, .format = format_e::hexadecimal}>(value, itbeg);
        std::basic_string_view res{itbeg, oit};
        constexpr_test(expected == res);
        }
        {
        ...
        constexpr auto expected{cfs("   0x0")};
        auto itbeg{buffer_.begin()};
        auto oit = stralgo::integral_to_ascii<traits{.precision = 6, .format = format_e::hexadecimal}>(value, itbeg);
        std::basic_string_view res{itbeg, oit};
        constexpr_test(expected == res);
        }
        {
        ...
        auto itbeg{buffer_.begin()};
        auto oit = stralgo::integral_to_ascii<
          traits{.precision = 6, .format = format_e::hexadecimal, .padd_with = padd_with_e::zeros}>(value, itbeg);
        std::basic_string_view res{itbeg, oit};
        constexpr_test(expected == res);
        }
        {
        ...
        constexpr auto expected{cfs("000000")};
        auto itbeg{buffer_.begin()};
        auto oit = stralgo::integral_to_ascii<traits{
          .precision = 6,
        ...
        auto itbeg{buffer_.begin()};
        auto oit = stralgo::integral_to_ascii<
          traits{.format = format_e::hexadecimal, .char_case = char_case_e::lowercase, .sign = prepend_sign_e::always}>(
          value, itbeg
        );
        std::basic_string_view res{itbeg, oit};
        constexpr_test(expected == res);
        ...
        auto itbeg{buffer_.begin()};
        auto oit = stralgo::integral_to_ascii<traits{
          .format = format_e::hexadecimal, .char_case = char_case_e::lowercase, .sign = prepend_sign_e::only_negative
        }>(value, itbeg);
        std::basic_string_view res{itbeg, oit};
        constexpr_test(expected == res);
        }
  ...
  "stralgo_integral_to_ascii_base2"_test = [&]
  {
    auto fn_tmpl = []<typename char_type>(char_type const *) -> metatests::test_result
    {
      ...
      using traits = stralgo::integral_format_traits;
        ...
        auto itbeg{buffer_.begin()};
        auto oit = stralgo::integral_to_ascii<traits{.format = format_e::binary}>(value, itbeg);
        std::basic_string_view res{itbeg, oit};
        constexpr_test(expected == res);
        }
        {
        ...
        constexpr auto expected{cfs("")};
        auto itbeg{buffer_.begin()};
        auto oit = stralgo::integral_to_ascii<traits{.precision = 0, .format = format_e::binary}>(value, itbeg);
        std::basic_string_view res{itbeg, oit};
        constexpr_test(expected == res);
        }
        {
        ...
        constexpr auto expected{cfs("   0b0")};
        auto itbeg{buffer_.begin()};
        auto oit = stralgo::integral_to_ascii<traits{.precision = 6, .format = format_e::binary}>(value, itbeg);
        std::basic_string_view res{itbeg, oit};
        constexpr_test(expected == res);
        }
        {
        ...
        constexpr auto expected{cfs("0B1010011")};
        auto itbeg{buffer_.begin()};
        auto oit = stralgo::integral_to_ascii<traits{.format = format_e::binary, .char_case = char_case_e::uppercase}>(
          value, itbeg
        );
        std::basic_string_view res{itbeg, oit};
        constexpr_test(expected == res);
        ...
        auto itbeg{buffer_.begin()};
        auto oit = stralgo::integral_to_ascii<
          traits{.format = format_e::binary, .include_prefix = include_prefix_e::no_prefix}>(value, itbeg);
        std::basic_string_view res{itbeg, oit};
        constexpr_test(expected == res);
        }
        {
        ...
        auto itbeg{buffer_.begin()};
        auto oit = stralgo::integral_to_ascii<
          traits{.precision = 10, .format = format_e::binary, .include_prefix = include_prefix_e::no_prefix}>(
          value, itbeg
        );
        std::basic_string_view res{itbeg, oit};
        constexpr_test(expected == res);
        ...
        auto itbeg{buffer_.begin()};
        auto oit = stralgo::integral_to_ascii<
          traits{.precision = 10, .format = format_e::binary, .include_prefix = include_prefix_e::with_prefix}>(
          value, itbeg
        );
        std::basic_string_view res{itbeg, oit};
        constexpr_test(expected == res);
        ...
        auto itbeg{buffer_.begin()};
        auto oit = stralgo::integral_to_ascii<
          traits{.precision = 68, .format = format_e::binary, .padd_with = padd_with_e::zeros}>(value, itbeg);
        std::basic_string_view res{itbeg, oit};
        constexpr_test(expected == res);
        }
        {
        ...
        auto itbeg{buffer_.begin()};
        auto oit = stralgo::integral_to_ascii<
          traits{.precision = 68, .format = format_e::binary, .padd_with = padd_with_e::space}>(value, itbeg);
        std::basic_string_view res{itbeg, oit};
        constexpr_test(expected == res);
        }
        {
  ...
  "stralgo_integral_to_string"_test = [&]
  {
    auto fn_tmpl = []<typename char_type>(char_type const *) -> metatests::test_result
    {
      ...
      constexpr cfs_t<char_type> cfs;
        ...
        constexpr int64_t value{-0x1ffeb3ef1ffeb3};
        constexpr auto expected{cfs("  -0x1ffeb3ef1ffeb3   ")};
        auto res = stralgo::integral_to_string<
          char_type,
          traits{
            .precision = 22,
            .format = format_e::hexadecimal,
        ...
        auto res = stralgo::integral_to_string<
          char_type,
          traits{.precision = 10, .format = format_e::binary, .include_prefix = include_prefix_e::with_prefix}>(value);
  ...
  "stralgo_estimate_float_to_string"_test = [&]
  {
    auto fn_tmpl = []() -> metatests::test_result
    {
      using traits = stralgo::float_format_traits;
        ...
        auto est_info = stralgo::detail::estimate_float_to_string<
          traits{.decimal_places = 4, .trailing_zeros = trailing_zeros_e::skip}>(value);
        constexpr_test(est_info.size() == 1);
        }
        {
        constexpr double value{0.0};
        auto est_info = stralgo::detail::estimate_float_to_string<
          traits{.precision = 0, .decimal_places = 4, .trailing_zeros = trailing_zeros_e::skip}>(value);
        ...
        constexpr double value{202.5};
        auto est_info = stralgo::detail::estimate_float_to_string<
          traits{.decimal_places = 4, .trailing_zeros = trailing_zeros_e::preserve}>(value);
  ...
  "stralgo_float_to_ascii"_test = [&]
  {
    auto fn_tmpl = []<typename char_type>(char_type const *) -> metatests::test_result
    {
      ...
      std::array<char_type, integral_to_string_max_size> buffer_{};
        ...
        constexpr double value{0.0};
        constexpr auto expected{cfs("0")};
        auto oit = stralgo::float_to_ascii<traits{.decimal_places = 4, .trailing_zeros = trailing_zeros_e::skip}>(
          value, buffer_.begin()
        );
        ...
        constexpr double value{0.0};
        constexpr auto expected{cfs("")};
        auto oit = stralgo::float_to_ascii<
          traits{.precision = 0, .decimal_places = 4, .trailing_zeros = trailing_zeros_e::skip}>(
          value, buffer_.begin()
        );
        std::basic_string_view res{buffer_.begin(), oit};
        constexpr_test(expected == res);
        ...
        auto oit = stralgo::float_to_ascii<traits{.decimal_places = 4, .trailing_zeros = trailing_zeros_e::preserve}>(
          value, buffer_.begin()
        );
        std::basic_string_view res{buffer_.begin(), oit};
        constexpr_test(expected == res);
        ...
        constexpr auto expected{cfs("0.5       ")};
        auto oit = stralgo::float_to_ascii<traits{
          .precision = 10, .decimal_places = 4, .alignment = alignment_e::left, .trailing_zeros = trailing_zeros_e::skip
        }>(value, buffer_.begin());
        std::basic_string_view res{buffer_.begin(), oit};
        constexpr_test(expected == res);
        }
  ...
  "stralgo_float_to_string"_test = [&]
  {
    auto fn_tmpl = []<typename char_type>(char_type const *) -> metatests::test_result
    {
      ...
      constexpr cfs_t<char_type> cfs;
        ...
        constexpr double value{120.5};
        constexpr auto expected{cfs("  120.5   ")};
        auto res = stralgo::float_to_string<
          char_type,
          traits{
            .precision = 10,
            .decimal_places = 4,
...
template<
  ...
  stralgo::concepts::char_range view_type,
...
template<std::floating_point float_type, stralgo::concepts::char_range view_type, typename expected_type>
constexpr auto test(view_type const & source, expected_type expected, int end_it_offset)
  {
...
static_assert(compose_arg_concept<small_vectors::u8string, char8_t>);
...
static_assert(compose_arg_concept<
              stralgo::detail::view_preconv_integral_t<int, stralgo::integral_format_traits{}>,
              char>);
    ...
    auto fn_tmpl = []<typename char_type>(char_type const *) -> metatests::test_result
    {
      constexpr cfs_t<char_type> cfs;
        ...
        auto res{stralgo::compose(
          ...
          cfs("] "),
          fmt<ptrfmt>(0x1ff56ef001),
          char_type(' '),  // reuse custom constexpr formatting
          fmt<ptrfmt>(0x0)
        )};
        ...
        auto res{stralgo::compose(
          cfs("output_filename"),
          char_type('_'),
          stralgo::fmt<stralgo::integral_format_traits{.precision = 4, .padd_with = padd_with_e::zeros}>(2),
          char_type('_'),
        ...
        using stralgo::fmt;
        constexpr stralgo::integral_format_traits _22dec{.precision = 2, .padd_with = stralgo::padd_with_e::zeros};
        auto res{stralgo::compose(
          tm_value.tm_yday,
          cfs(" days "),
          fmt<_22dec>(tm_value.tm_hour),
          char_type(':'),
          fmt<_22dec>(tm_value.tm_min),
          char_type(':'),
          fmt<_22dec>(tm_value.tm_sec)
        )};
