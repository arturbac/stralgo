...
namespace stralgo
{
  ...
  template<typename string_view_type, typename char_type,
    std::enable_if_t<strconcept::is_char_type_v<char_type>, bool> = true>
  [[nodiscard]]
  constexpr auto trim_left( string_view_type const & view, char_type value) noexcept
    {
    static_assert(std::is_same_v<strconcept::string_view_value_type<string_view_type>,char_type>);
  ...
  template<typename string_view_type, typename string_view_type2,
    typename = std::enable_if_t<!strconcept::is_char_type_v<string_view_type2>>
            >
  [[nodiscard]]
  ...
  template<typename string_view_type, typename string_view_type2,
    std::enable_if_t<!strconcept::is_char_type_v<string_view_type2>, bool> = true>
  [[nodiscard]]
  ...
  template<typename string_view_type, typename char_type,
    typename = std::enable_if_t<
      ...
      && std::is_same_v<strconcept::string_view_value_type<string_view_type>,char_type>>
      >
  [[nodiscard]]
