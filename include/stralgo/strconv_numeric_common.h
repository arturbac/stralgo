...
enum struct input_format_e : uint8_t
  {
  undetermined,
  decimal,
  hexadecimal
...
enum struct padd_with_e : bool
  {
  space,
  zeros
  };

enum struct prepend_sign_e : bool
  {
  only_negative,
  always
  };

enum struct include_prefix_e : bool
  {
  no_prefix,
  with_prefix
  };

enum struct alignment_e : uint8_t
  {
  left,
  middle,
  right
