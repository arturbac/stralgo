  ...
  stralgo_static_call_operator constexpr auto operator()(
    ...
    if(cp < 0x80)
      ...
      *result = static_cast<char_type>(cp);
      ...
      {
      // u+0080 	u+07ff 	110xxxxx 	10xxxxxx
      *result = static_cast<char_type>(lead_110 | (cp >> 6));
      ++result;
      *result = static_cast<char_type>(lead_10 | (cp & mask_6b));
      ...
      {
      // u+0800 	u+ffff 	1110xxxx 	10xxxxxx 	10xxxxxx
      *result = static_cast<char_type>(lead_1110 | (cp >> 12));
      ++result;
      *result = static_cast<char_type>(lead_10 | ((cp >> 6) & mask_6b));
      ++result;
      *result = static_cast<char_type>(lead_10 | (cp & mask_6b));
      ++result;
      }
      ...
      {
      // u+10000 	[b]u+10ffff 	11110xxx 	10xxxxxx 	10xxxxxx 	10xxxxxx
      *result = static_cast<char_type>(lead_11110 | (cp >> 18));
      ++result;
      *result = static_cast<char_type>(lead_10 | ((cp >> 12) & mask_6b));
      ++result;
      *result = static_cast<char_type>(lead_10 | ((cp >> 6) & mask_6b));
      ++result;
      *result = static_cast<char_type>(lead_10 | (cp & mask_6b));
  ...
  stralgo_static_call_operator constexpr auto operator()(
    ...
    if(cp > 0xffffu)
      ...
      *result = static_cast<char_type>((cp >> 10) + lead_offset);
      ++result;
      *result = static_cast<char_type>((cp & mask_10b) | trail_surrogate_min);
      ++result;
      }
    else
      {
...
struct rewind_back_t
  {
  stralgo_static_call_operator constexpr auto operator()(concepts::octet_iterator auto & iter
  ) stralgo_static_call_operator_const noexcept
    {
    --iter;
  ...
  stralgo_static_call_operator constexpr auto operator()(concepts::u16bit_iterator auto & iter
  ) stralgo_static_call_operator_const noexcept
    {
    --iter;
  ...
  stralgo_static_call_operator constexpr auto operator()(concepts::u32bit_iterator auto & iter
  ) stralgo_static_call_operator_const noexcept
    {
    --iter;
    }
